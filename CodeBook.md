...
This code book describes the variables, data, and transformaions that were done by run_analysis script.
...
Instead of Id activity description were added as "Activity" variable.
...
The data set is written to the file 'tidy_data2.txt'.
